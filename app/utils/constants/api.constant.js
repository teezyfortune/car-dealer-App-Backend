export default {
  ...
  RESOURCE_VERIFICATION_FAIL: (resource) => `${resource}_VERIFICATION_FAIL`,
  RESOURCE_VERIFICATION_FAIL_MSG: (resource) => `${resource} resource verification fail`,
  ...
  ERROR_UPLOADING_FILE_MSG: 'Error uploading file',
  ...
  FAIL: 'fail',
  ERROR_VALIDATING_FILE: 'Error validating file'
};
